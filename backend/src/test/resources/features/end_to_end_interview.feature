Feature: End-to-End Interview Flow
  ...
  Scenario: Complete full interview lifecycle for Hangman question
    # Step 1: HR creates interview
    Given a candidate with id "candidate-e2e-001"
    And an interviewer with id "interviewer-e2e-001"
    When I create an interview with title "Hangman Interview E2E" scheduled at "2026-04-01T10:00:00Z"
