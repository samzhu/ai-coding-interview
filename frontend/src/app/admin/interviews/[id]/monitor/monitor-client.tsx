...
import type { InterviewResponse, CheckpointResultResponse } from "@/types/interview";
import type { ConversationHistoryResponse } from "@/types/ai";
...
export function MonitorClient() {
  const interviewId = useRouteParam("/admin/interviews/:id/monitor", "id");
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b shrink-0">
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="sm" asChild>
            <Link href={`/admin/interviews/${interviewId}`}>← 返回詳情</Link>
          </Button>
